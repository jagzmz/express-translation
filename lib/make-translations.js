...
const replaceBodyWithOriginalKeys =
    function (dataBody = {}, fieldName, translatedFieldName) {
...
const handleObjectTranslations =
    function (dataBody = {}, dataSchema = {}, isResponse = false) {
        ...
        for (const field in dataSchema) {
            ...
            if (Array.isArray(dataSchema[field])) {
                handleArrayTranslations
                    .apply(this, [dataBody[field], dataSchema[field], isResponse]);
            }

            if (isJSON(dataSchema[field])) {
                handleObjectTranslations
                    .apply(this, [dataBody[field], dataSchema[field], isResponse]);
            }
            if (isResponse && dataSchema[field] === true) {
                replaceBodyWithOriginalKeys
                    .apply(this, [dataBody, field, translatedFieldName]);
            } else {
...
const makeTranslations = function (dataBody, apiConfig, isResponse = false, serialize = false) {
    ...
    if (isSchemaArray) {
        return handleArrayTranslations.apply(this, [dataBody, dataSchema, isResponse]);
    }

    return handleObjectTranslations.apply(this, [dataBody, dataSchema, isResponse]);
};
