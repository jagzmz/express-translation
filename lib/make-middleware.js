...
const IGNORE_KEY = 'ignoreTranslation'
...
const makeMiddleWare = function () {
    ...
    return function etMiddleware(req, res, next) {
        ...
        ignoreTranslation = ignoreTranslation && (req.get(self.triggerHeader) === ignoreTranslation);
        
        if (!req.get(self.triggerHeader) || ignoreTranslation) {
